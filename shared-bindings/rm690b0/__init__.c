...
static const mp_rom_map_elem_t rm690b0_module_globals_table[] = {
    ...
    { MP_ROM_QSTR(MP_QSTR_RENDER_FRAMEBUFFER), MP_ROM_INT(RM690B0_RENDER_FRAMEBUFFER) },
    { MP_ROM_QSTR(MP_QSTR_RENDER_DISPLAY_LIST), MP_ROM_INT(RM690B0_RENDER_DISPLAY_LIST) },
